...
alias sf="scanfiles.ksh"
alias execp="execp.ksh"
...
if [ "$host" = "svappl15" ] ; then
	...
	alias scmhome="cd $SCM_HOME"
  export SH_HOME=$SCM_HOME/sh
  alias shhome="cd $SH_HOME"
  export RUN_HOME=/data/scm
	export PROD_HOME=/data/scm
  export PROD_SH=$PROD_HOME/sh
  alias shrun="cd $PROD_SH"
  export PROD_SQL=$RPOD_HOME/sql
  export PROD_LOAD=$RPOD_HOME/load
  export PROD_DATA=$RPOD_HOME/PROD
  export TEST_DATA=$RPOD_HOME/TEST
  alias tstdat="cd $TEST_DATA"
  ...
  alias shpub="cd $PUB_RUN_HOME"
	...
	export PROD_EXE=$PROD_HOME/c/exe
	alias prdexe="cd  $PROD_EXE"
	export LOAD_HOME=${SCM_HOME}/load
	alias loadhome="cd  $LOAD_HOME"
	export EXE_HOME=${SCM_HOME}/c/exe
  ...
  export PATH=$HOME/bin:${PATH}:$ORACLE_HOME/bin:$SCM_HOME/splint-3.1.1/bin:$SH_RUN_HOME:.
  export LARCH_PATH=/mcair/dev/appl/scm/splint-3.1.1/lib

elif [ "$host" = "svappl16" ] ; then

  export PROD_HOME=/data/scm
  export PROD_DATA=$PROD_HOME/PROD
  alias dathome ="cd $PROD_DATA"
  alias prdhome="cd $PROD_HOME"
  ...
  export PATH=$SH_HOME:$HOME/bin:${PATH}:$ORACLE_HOME/bin:.
  # prod scripts
