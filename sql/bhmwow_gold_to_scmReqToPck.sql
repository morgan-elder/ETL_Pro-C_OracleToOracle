...
begin
declare
		vSegCode		wow_seg_code_info.seg_code%type;
		vSystem                 wow_seg_code_info.system%type;
		...
		vRequest_nbr		requests_to_pick.request_nbr%type;
		...
		BEGIN				
			...
			LOOP
				...
				LOOP
					...
					THEN
						SELECT 		request_seq.nextval seq 
						INTO		vReqSeq
						FROM		dual;
					...
					THEN
						...
						FROM	warehouse_picking_activity a, requests_to_pick b
